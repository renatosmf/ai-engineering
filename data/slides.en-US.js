/**
 * EN-US slide content and metadata.
...
export const translations = {
  htmlLang: 'en-US',
        ...
        metaDescription: 'Reveal.js presentation about AI-assisted development for developers who are new to the topic.',
        selectorLabel: 'Language',
        footer: 'Tip: press <strong>S</strong> for speaker view, <strong>F</strong> for fullscreen, or use <strong>?print-pdf</strong> for print layout.',
        slides: [
          `<section>
            <div class="hero">
              <div>
                <span class="eyebrow">🤝 Engineering with AI</span>
                <h1>AI-Assisted Development</h1>
                <div class="accent-line"></div>
                <p class="subtitle">A practical introduction for people who are new to the topic: what AI is good at, where it fails, how to guide it, and how to validate without lowering quality.</p>
                <div class="chip-row">
                  <span class="chip">🇺🇸 Content in EN-US</span>
                  <span class="chip">🧭 Real walkthrough</span>
                  <span class="chip">✅ Contracts + validation</span>
                  <span class="chip">🛠️ Before/after examples</span>
                </div>
              </div>
              <div class="panel">
                <h3>Who is this for?</h3>
                <p>Developers, tech leads, QA, and product managers who want to use AI in a safe and genuinely useful way — without relying on magic.</p>
                <div class="stats">
                  <div class="stat-card fragment fade-up">
                    <div class="value">Week 1</div>
                    <div class="muted">Focus on small, repetitive, well-defined tasks</div>
                  </div>
                  <div class="stat-card fragment fade-up">
                    <div class="value">2x–4x</div>
                    <div class="muted">Common gain in first drafts when the request is clear</div>
                  </div>
                  <div class="stat-card fragment fade-up">
                    <div class="value">0%</div>
                    <div class="muted">Reduction in human responsibility for architecture, risk, and release</div>
                  </div>
                  <div class="stat-card fragment fade-up">
                    <div class="value">Highest value</div>
                    <div class="muted">When prompts, context, examples, and tests are aligned</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          `<section>
            <span class="eyebrow">🎯 Why does this matter?</span>
            <h2>O problema não é “escrever código”. É entregar mudança confiável.</h2>
            <div class="grid-2">
              <div class="card fragment fade-right">
                <h4>Without structured assistance</h4>
                <ul>
                  <li>Time is lost on boilerplate, repetitive tests, and delayed documentation.</li>
                  <li>Context is scattered across tickets, chat, wiki pages, and pull requests.</li>
                  <li>It is easier to miss validations, business rules, and edge cases.</li>
                  <li>Pressure for speed turns into shortcuts — and rework grows.</li>
                </ul>
              </div>
              <div class="card fragment fade-left">
                <h4>With well-guided assistance</h4>
                <ul>
                  <li>AI accelerates drafts, tests, refactors, and documentation.</li>
                  <li>The team makes context, criteria, and contracts explicit earlier.</li>
                  <li>Validation gets stronger: tests, linters, contracts, and independent review.</li>
                  <li>The real gain shows up in validated throughput, not lines of code.</li>
                </ul>
              </div>
            </div>
          ...
          `<section>
            ...
            <h2>Four concepts that unlock the topic for beginners</h2>
            <div class="grid-4">
              ...
              <div class="card fragment fade-up">
                <h4>🧠 AI writing code ≠ AI-assisted development</h4>
          ...
          `<section>
            <span class="eyebrow">🕸️ Visual model</span>
            <h2>How agents, contracts, and validation work together</h2>
            <div class="diagram">
          ...
          `<section>
            <section data-auto-animate>
              ...
              <h2>Practical example: iOS development with AI</h2>
...
<pre style="font-size: 0.5em; margin: 12px 0;"><code class="language-swift">class RegistrationViewModel: ObservableObject {
  ...
  func register() {
    ...
    useCase.execute(email: email, password: password)
          ...
          `<section>
            <span class="eyebrow">⚠️ Common mistakes</span>
            <h2>Where beginners usually stumble — and how to avoid it</h2>
            <div class="grid-2">
              <div class="card fragment fade-right">
...
Entrega: diff + testes + breve justificativa das decisões.</code></pre>
          ...
          `<section>
            ...
            <h2>What to expect and how to measure whether it works</h2>
          ...
          `<section>
            <span class="eyebrow">🏗️ Operating model</span>
            <h2>Recommended framework for an early-stage team</h2>
            <div class="diagram">
              <div class="flow">
          ...
          `<section>
            <span class="eyebrow">⚖️ Trade-offs and best practices</span>
          ...
          `<section>
            <span class="eyebrow">⚠️ The Problem</span>
            <h2>Without architecture, AI adoption becomes inconsistent and hard to scale</h2>
            <div class="compare">
              <div class="card fragment fade-right">
          ...
          `<section>
            <section data-auto-animate>
              <span class="eyebrow">🏗️ Proposed Solution</span>
              <h2>A 4-layer architecture that makes AI structured, declarative, auditable, and enforceable</h2>
              <div class="diagram">
...
└── knowledge/      # Base de conhecimento</code></pre>
          ...
          `<section>
            <section data-auto-animate>
              ...
              <h2>Spec-driven development starts by defining contracts and rules before execution</h2>
      ...
      "viewModel": {
        "properties": {
          ...
          `<section>
            ...
            <h2>Agents and skills specialize AI behavior for recurring work</h2>
            <div class="split">
              <div class="card fragment fade-right">
                <h4>O que é e por que importa</h4>
                <ul>
...
interface:
  ...
  short_description: "Implement new capabilities with quality gates"</code></pre>
          ...
          `<section>
            ...
            <h2>Independent execution and judgment improve impartiality and quality</h2>
            <div class="split">
              <div class="card fragment fade-right">
                <h4>O que é e por que importa</h4>
                <ul>
...
<pre><code class="language-text">Implementation Agent → submits → Validation Agent
          ...
          `<section>
            ...
            <h2>Harnesses and gates turn intent into automated enforcement</h2>
            <div class="compare">
              <div class="card fragment fade-right">
                <h4>O que é e por que importa</h4>
                <ul>
...
if [ $VIOLATIONS -eq 0 ]; then
  ...
  exit 1
          ...
          `<section>
            <span class="eyebrow">🔄 E2E Example</span>
          ...
          `<section>
            ...
            <h2>Why this approach tends to outperform ad hoc prompting</h2>
            <div class="grid-3">
          ...
          `<section>
            ...
            <h2>There is an adoption cost — and it pays off more in some contexts</h2>
            <div class="compare">
              <div class="card fragment fade-right">
          ...
          `<section>
            <span class="eyebrow">🚀 Getting Started</span>
            <h2>How a team can begin adopting this architecture</h2>
            <div class="timeline">
              <div class="timeline-step fragment fade-up">
                <div class="step-number">1</div>
          ...
          `<section>
            <div class="qa">
              <div>
                <span class="eyebrow">❓ Summary &amp; Q&amp;A</span>
                <div class="hero-question">Spec-driven, layered, automated, and enforceable</div>
                <p class="subtitle" style="max-width: 100%; margin: 18px auto 0; text-align: center;">Suggested next step: pilotar a abordagem com um time ou feature, medir resultado e evoluir a arquitetura com base em evidência. Perguntas são bem-vindas.</p>
                ...
                <p style="margin-top: 36px; font-size: 0.7em; color: var(--muted); text-align: center;">Presented by <strong style="color: var(--text-strong);">Renato S. Machado Filho</strong></p>
              </div>
            </div>
          </section>`
        ]
